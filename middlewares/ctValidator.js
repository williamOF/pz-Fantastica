...
const validarUsuario = (req, res, next) => {
    const {user_fullname, user_email, re_user_email, user_password, re_user_password} = req.body

    let errors = []

    if(user_fullname.length < 10 ){
        errors.push('insira o nome completo, nome muito curto')
    }
